 ...
 * @author Shrimoyee
 */
public class sellerMain extends javax.swing.JPanel {
    ...
    public sellerMain(JPanel userProcessContainer, useracc account, seller sellerOrganization, Enterprise enterprise,ecosystem business) {
        initComponents();
    ...
    public void populateMyQTable(){
        ...
        for(Request wk : account.getWorkQueue().getWorkRequestList()){
            if (wk instanceof SellerOrg){
                ...
                row1[0] = ((SellerOrg) wk).getProdName();
                row1[1] = ((SellerOrg) wk).getProdPrice();
                row1[2] = ((SellerOrg) wk).getStock();
