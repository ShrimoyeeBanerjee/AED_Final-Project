...
public class UserAcc extends javax.swing.JPanel {
    ...
    public UserAcc(JPanel container, Enterprise enterprise,useracc account,ecosystem business) {
        initComponents();
    ...
    public void populateEmployeeComboBox(organization organization){
        ...
        for (Employe employee : organization.getEmployeeDirectory().getEmployeeList()){
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        Employe employee = (Employe) employeeJComboBox.getSelectedItem();
